...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        [button setBackgroundImage:[UIImage imageNamed:@"tabBar_guangjie"] forState:UIControlStateNormal];
        [button setBackgroundImage:[UIImage imageNamed:@"tabBar_guangjie"] forState:UIControlStateHighlighted];
//        [button setImage:[UIImage imageNamed:@"tabBar_guangjie"] forState:UIControlStateNormal];
//        [button setImage:[UIImage imageNamed:@"tabBar_guangjie"] forState:UIControlStateHighlighted];
