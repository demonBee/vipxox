//
//  DepartmentCommitListViewController.m
//  Vipxox
//
...
@interface DepartmentCommitListViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation DepartmentCommitListViewController
...
#pragma mark  --data
-(void)getPinlunDatas{
//   http://www.vipxox.cn/? m=app&s=baihuo&act=dianping_list&pid=3
    ...
    NSDictionary*params=@{@"m":@"app",@"s":@"baihuo",@"act":@"dianping_list",@"pid":self.pid,@"pagen":pagen,@"pages":pages};
...
-(void)configureCell:(CommitTableViewCell*)cell atIndexPath:(NSIndexPath*)indexPath{
    ...
    [cell FourCan:isCommitList andDict:model];
