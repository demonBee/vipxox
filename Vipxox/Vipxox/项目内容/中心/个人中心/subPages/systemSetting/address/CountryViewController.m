...
-(void)getDatas{
//   http://www.vipxox.cn/?  m=appapi&s=membercenter&act=receipt_address_guo&uid=1
    
    NSMutableString *urlStr=[NSMutableString stringWithFormat:@"%@", HTTP_ADDRESS];
    NSDictionary*params=@{@"m":@"appapi",@"s":@"membercenter",@"act":@"receipt_address_guo",@"uid":[UserSession instance].uid};
