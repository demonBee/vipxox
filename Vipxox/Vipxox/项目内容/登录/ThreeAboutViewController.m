...
@interface ThreeAboutViewController ()
...
@implementation ThreeAboutViewController
...
//    [mailBoxView addSubview:_mailBoxTextField];
    ...
    //“输入密码”
    UIView *secretCodeView=[[UIView alloc]initWithFrame:CGRectMake(ACTUAL_WIDTH(20), ACTUAL_HEIGHT(155), ACTUAL_WIDTH(336), ACTUAL_HEIGHT(40))];
...
//        NSDictionary*dict=@{@"m":@"appapi",@"s":@"register",@"zt":@"register",@"email":self.mailBoxTextField.text};
...
//        NSString*email=self.mailBoxTextField.text;
        NSDictionary*params=@{@"m":@"appapi",@"s":@"connect_register",@"user":user,@"pwd":pwd,@"cid":self.cid};
        HttpManager*manager=[[HttpManager alloc]init];
